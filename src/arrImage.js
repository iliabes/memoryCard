...
export const tau = ['tau/tau1','tau/tau2','tau/tau3','tau/tau4','tau/tau5','tau/tau6','tau/tau7','tau/tau8','tau/tau9','tau/tau10','tau/tau11','tau/tau12','tau/tau13']
export const imperiums = ['impeiym4','impeiym5','impeiym6','impeiym9','eldar4','eldar3']
export const orks = ['orks/ork1','orks/ork2','orks/ork3','orks/ork4','orks/ork5','orks/ork6','orks/ork7','orks/ork8','orks/ork9','orks/ork10','orks/ork11']
export const faceImg = ['face1','face2','face3']
export const toastyPers = ['impi.png','orkFace.png','tau.png']
let fraction1 = [spaceMarines,orks,tau]
